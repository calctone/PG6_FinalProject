...
lazy val root = (project in file(".")).
  settings(
    name := "PG6_CollaborativeFilteringALS",
    version := "0.0.1",
    scalaVersion := "2.10.4",
    mainClass in Compile := Some("edu.umkc.ic.PG6_CollaborativeFilteringALS")
  )

exportJars := true
fork := true
assemblyJarName := "PG6_CollaborativeFilteringALS.jar"
val meta = """META.INF(.)*""".r
